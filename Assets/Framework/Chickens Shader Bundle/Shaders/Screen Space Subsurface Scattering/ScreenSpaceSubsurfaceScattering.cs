...
public class ScreenSpaceSubsurfaceScattering : MonoBehaviour {
    ...
    void OnRenderImage(RenderTexture source,RenderTexture destination)
    {
        ...
        scam.renderingPath = this.camera.renderingPath;
        ...
        scam.backgroundColor = new Color(0, 0, 0, 0);
        ...
        scam.targetTexture = scam_rdTex;
        scam.depthTextureMode = DepthTextureMode.Depth;
        scam.RenderWithShader(m_DepthShader, "Scattering");
        scam.depthTextureMode = DepthTextureMode.None;
        //Graphics.Blit(scam_rdTex, destination, m_MixMaterial, 6);
        //Graphics.Blit(source, depth, m_MixMaterial, 2);
		m_MixMaterial.SetTexture("_SecDepth", scam_dTex);
        m_MixMaterial.SetTexture("_SecRealDepth", scam_rdTex);
		...
		Graphics.Blit(source, tempLight, m_MixMaterial, 7);
        ...
        RenderTexture.ReleaseTemporary(scam_rdTex);

Shader "Chickenlord/3.5/Skin/Cutout/SSS Skinshader 1.31 Specularmap"{
	Properties {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf BlinnPhongSSSLayer3 nolightmap fullforwardshadows addshadow alphatest:_Cutout novertexlights
		#pragma target 3.0
